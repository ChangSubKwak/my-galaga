...
// (The COMBO_ARSENAL registry guard was deleted with the registry. It handed out
// weapons the player did not choose on top of the weapon they did, which is the
// inverse of THE MANIFEST — see the note at its old site in index.html.)
...
if (typeof G.directorBudget === 'function' && typeof G.directorAdmit === 'function') {
  ...
  if (typeof G.directorCensus === 'function' && G.__getGame && G.__getGame()) {
    ...
    // (THE REDOUBT's emplacement-set clause went with THE REDOUBT. It was the
    // seventh census contributor, and the rule it encoded — that a whole SET of
    // player-placed objects counts as ONE occupant, never one each — stays true
    // of anything that ever replaces it.)
